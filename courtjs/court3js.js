...
const renderControls = new function () {
    ...
    this.addControls = function () {
        ...
        gui.addColor(obj, 'Border color').onChange(value => {
            ...
            renderer.render(scene, camera);
            socket.emit('propChanges', {
                "meshName": "borderupPlane1Mesh",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "borderbottomPlane1Mesh",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "borderleftPlane1Mesh",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "borderrightPlane1Mesh",
                "value": value
            });
        ...
        gui.addColor(obj, 'Keys color').onChange(value => {
            ...
            renderer.render(scene, camera);
            socket.emit('propChanges', {
                "meshName": "keysrightPlane1Mesh",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "keysleftPlane1Mesh",
                "value": value
            });
        });;
        gui.addColor(obj, 'Line color').onChange(value => {
            ...
            renderer.render(scene, camera);
            socket.emit('propChanges', {
                "meshName": "ellipseRight",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "ellipseLeft",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "ellipseLeftBig",
                "value": value
            });
            socket.emit('propChanges', {
                "meshName": "ellipseRightBig",
                "value": value
            });
